...
import com.ctt.format.setting.FormatSetting;
...
public class GenerateGSAction extends AnAction {
    ...
    private String format(String string, PsiField field) {
        ...
        if("get".equals(string)) {
            oldContent = this.formatSetting.getGetFormat().replaceAll("#\\{bare_field_comment}", oldContent).replaceAll("\\$\\{bare_field_comment}", field.getName());
        } else if("set".equals(string)) {
            oldContent = this.formatSetting.getSetFormat().replaceAll("#\\{bare_field_comment}", oldContent).replaceAll("\\$\\{param}", field.getName());
        }
